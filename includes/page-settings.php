...
function imagepress_admin_page() {
    ...
    <div class="wrap">
        ...
        <?php if ($tab === 'dashboard_tab') {
            ...
            <?php
            $author_slug = imagepress_get_option('cinnamon_author_slug');
            $author_login_url = imagepress_get_option('cinnamon_account_page');
            $author_edit_url = imagepress_get_option('cinnamon_edit_page');
            $ip_profile_page = imagepress_get_option('ip_profile_page');
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="ip_box_ui" id="ip_box_ui">
                                    <option value="default"<?php if ((string) imagepress_get_option('ip_box_ui') === 'default') echo ' selected'; ?>>Default</option>
                                    <option value="overlay"<?php if ((string) imagepress_get_option('ip_box_ui') === 'overlay') echo ' selected'; ?>>Overlay</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                            <p>
                                <input name="ip_slug" id="slug" type="text" class="regular-text code" placeholder="Image slug" value="<?php echo (string) imagepress_get_option('ip_slug'); ?>" required> <label for="ip_slug"><b>Image</b> slug</label>
                            ...
                            <p>
                                <select name="ip_image_size" id="ip_image_size">
                                    <optgroup label="WordPress (default)">
                                        <option value="thumbnail"<?php if ((string) imagepress_get_option('ip_image_size') === 'thumbnail') echo ' selected'; ?>>Thumbnail</option>
                                        <option value="medium"<?php if ((string) imagepress_get_option('ip_image_size') === 'medium') echo ' selected'; ?>>Medium</option>
                                    </optgroup>
                                    <optgroup label="ImagePress (default)">
                                        <option value="imagepress_sq_std"<?php if ((string) imagepress_get_option('ip_image_size') === 'imagepress_sq_std') echo ' selected'; ?>>Standard (Square)</option>
                                        <option value="imagepress_pt_std"<?php if ((string) imagepress_get_option('ip_image_size') === 'imagepress_pt_std') echo ' selected'; ?>>Standard (Portrait)</option>
                                        <option value="imagepress_ls_std"<?php if ((string) imagepress_get_option('ip_image_size') === 'imagepress_ls_std') echo ' selected'; ?>>Standard (Landscape)</option>
                                    </optgroup>
                                    <optgroup label="Other registered sizes (use with care)">
                                        <?php
                                        $ip_image_size = imagepress_get_option('ip_image_size');
                                        $thumbsize = isset($ip_image_size) ? esc_attr($ip_image_size) : '';
                                        $image_sizes = imagepress_return_image_sizes();
                            ...
                            <p>
                                <select name="ip_title_optional" id="ip_title_optional">
                                    <option value="0"<?php if(imagepress_get_option('ip_title_optional') == 0) echo ' selected'; ?>>Hide image title</option>
                                    <option value="1"<?php if(imagepress_get_option('ip_title_optional') == 1) echo ' selected'; ?>>Show image title</option>
                                </select>
                                <label for="ip_title_optional">Show/hide image title</label>
                            </p>
                            <p>
                                <select name="ip_meta_optional" id="ip_meta_optional">
                                    <option value="0"<?php if(imagepress_get_option('ip_meta_optional') == 0) echo ' selected'; ?>>Hide image meta</option>
                                    <option value="1"<?php if(imagepress_get_option('ip_meta_optional') == 1) echo ' selected'; ?>>Show image meta</option>
                                </select>
                            ...
                            <p>
                                <select name="ip_views_optional" id="ip_views_optional">
                                    <option value="0"<?php if(imagepress_get_option('ip_views_optional') == 0) echo ' selected'; ?>>Hide image views</option>
                                    <option value="1"<?php if(imagepress_get_option('ip_views_optional') == 1) echo ' selected'; ?>>Show image views</option>
                                </select>
                                <label for="ip_views_optional">Show/hide the number of image views</label>
                            </p>
                            <p>
                                <select name="ip_likes_optional" id="ip_likes_optional">
                                    <option value="0"<?php if(imagepress_get_option('ip_likes_optional') == 0) echo ' selected'; ?>>Hide image likes</option>
                                    <option value="1"<?php if(imagepress_get_option('ip_likes_optional') == 1) echo ' selected'; ?>>Show image likes</option>
                                </select>
                                <label for="ip_likes_optional">Show/hide the number of image likes</label>
                            </p>
                            <p>
                                <select name="ip_comments" id="ip_comments">
                                    <option value="0"<?php if(imagepress_get_option('ip_comments') == '0') echo ' selected'; ?>>Hide image comments</option>
                                    <option value="1"<?php if(imagepress_get_option('ip_comments') == '1') echo ' selected'; ?>>Show image comments</option>
                                </select>
                                <label for="ip_comments">Show/hide the number of image comments</label>
                            </p>
                            <p>
                                <select name="ip_author_optional" id="ip_author_optional">
                                    <option value="0"<?php if(imagepress_get_option('ip_author_optional') == 0) echo ' selected'; ?>>Hide image author</option>
                                    <option value="1"<?php if(imagepress_get_option('ip_author_optional') == 1) echo ' selected'; ?>>Show image author</option>
                                </select>
                ...
                <table class="form-table">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input name="ip_ipp" id="ip_ipp" type="number" value="<?php echo (int) imagepress_get_option('ip_ipp'); ?>" min="1" max="65536">
                                ...
                                <p>
                                    ...
                                    <select name="ip_order" id="ip_order">
                                        <option value="ASC"<?php if (imagepress_get_option('ip_order') == 'ASC') echo ' selected'; ?>>ASC</option>
                                        <option value="DESC"<?php if (imagepress_get_option('ip_order') == 'DESC') echo ' selected'; ?>>DESC</option>
                                    </select> <label for="ip_orderby">by</label> <select name="ip_orderby" id="ip_orderby">
                                        <option value="none"<?php if (imagepress_get_option('ip_orderby') == 'none') echo ' selected'; ?>>none</option>
                                        <option value="ID"<?php if (imagepress_get_option('ip_orderby') == 'ID') echo ' selected'; ?>>ID</option>
                                        <option value="author"<?php if (imagepress_get_option('ip_orderby') == 'author') echo ' selected'; ?>>author</option>
                                        <option value="title"<?php if (imagepress_get_option('ip_orderby') == 'title') echo ' selected'; ?>>title</option>
                                        <option value="name"<?php if (imagepress_get_option('ip_orderby') == 'name') echo ' selected'; ?>>name</option>
                                        <option value="date"<?php if (imagepress_get_option('ip_orderby') == 'date') echo ' selected'; ?>>date</option>
                                        <option value="rand"<?php if (imagepress_get_option('ip_orderby') == 'rand') echo ' selected'; ?>>rand</option>
                                        <option value="comment_count"<?php if (imagepress_get_option('ip_orderby') == 'comment_count') echo ' selected'; ?>>comment_count</option>
                                    </select>
                                </p>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <p>
                                    <input type="number" name="ip_app" id="ip_app" min="1" max="9999" value="<?php echo (int) imagepress_get_option('ip_app'); ?>">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                wp_dropdown_pages([
                                    ...
                                    'option_none_value' => '0',
                                    'selected' => (int) imagepress_get_option('ip_collections_page')
                                ]);
                                ?>
        ...
        <?php } else if ($tab === 'settings_tab') {
            if (isset($_POST['isGSSubmit'])) {
                ...
                update_option('imagepress_use_lightbox', (int) sanitize_text_field($_POST['imagepress_use_lightbox']));
                ...
                <table class="form-table">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <select name="ip_registration" id="ip_registration">
                                    <option value="0"<?php if ((int) imagepress_get_option('ip_registration') === 0) echo ' selected'; ?>>Require user registration (recommended)</option>
                                    <option value="1"<?php if ((int) imagepress_get_option('ip_registration') === 1) echo ' selected'; ?>>Do not require user registration</option>
                                </select>
                            ...
                            <td>
                                <p>
                                    <select name="ip_click_behaviour" id="ip_click_behaviour">
                                        <option value="media"<?php if ((string) imagepress_get_option('ip_click_behaviour') === 'media') echo ' selected'; ?>>Open media (image)</option>
                                        <option value="custom"<?php if ((string) imagepress_get_option('ip_click_behaviour') === 'custom') echo ' selected'; ?>>Open image page</option>
                                    </select>
                                    <br><small>What to open when clicking on an image (single image or custom post template).</small>
                                </p>
                                <p>
                                    <input type="checkbox" class="wppd-ui-toggle" id="imagepress_use_lightbox" name="imagepress_use_lightbox" value="1" <?php if ((int) get_option('imagepress_use_lightbox') === 1) echo 'checked'; ?>> <label for="imagepress_use_lightbox">Use a lightbox for image links</label>
                                </p>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <select name="ip_moderate" id="ip_moderate">
                                    <option value="0"<?php if ((int) imagepress_get_option('ip_moderate') === 0) echo ' selected'; ?>>Moderate all images (recommended)</option>
                                    <option value="1"<?php if ((int) imagepress_get_option('ip_moderate') === 1) echo ' selected'; ?>>Do not moderate images</option>
                                </select>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" name="ip_cat_moderation_include" id="ip_cat_moderation_include" value="<?php echo imagepress_get_option('ip_cat_moderation_include'); ?>">
                ...
                <table class="form-table">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input type="url" name="ip_upload_redirection" id="ip_upload_redirection" placeholder="https://" class="regular-text" value="<?php echo imagepress_get_option('ip_upload_redirection'); ?>">
                ...
                <table class="form-table">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input type="text" name="ip_notification_email" id="ip_notification_email" value="<?php echo imagepress_get_option('ip_notification_email'); ?>" class="regular-text">
                ...
                <table class="form-table">
                    <tbody>
                            ...
                            <td>
                                <p>
                                    ...
                                    wp_dropdown_pages([
                                        ...
                                        'option_none_value' => 0,
                                        'selected' => imagepress_get_option('ip_profile_page'),
                                    ]);

                                    $ipProfilePage = (int) imagepress_get_option('ip_profile_page')
                                    ?>
                                    <br><small>Make sure you add the <code>[cinnamon-profile]</code> shortcode on this page.</small>
                                </p>
                                <p>
                                    <input type="text" name="cinnamon_author_slug" id="cinnamon_author_slug" value="<?php echo imagepress_get_option('cinnamon_author_slug'); ?>" class="regular-text code">
                                    <br><small>Default is <b>author</b> (usage exemples: <b>author</b>, <b>profile</b> or <b>hub</b>).</small>
                                    <br><small>User profile URL will look like <code class="codor"><?php echo get_permalink($ipProfilePage) . '?<b>' . imagepress_get_option('cinnamon_author_slug') . '</b>='; ?>username</code>.</small>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="url" name="cinnamon_account_page" id="cinnamon_account_page" value="<?php echo imagepress_get_option('cinnamon_account_page'); ?>" class="regular-text" placeholder="https://">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                wp_dropdown_pages([
                                    ...
                                    'option_none_value' => 0,
                                    'selected' => imagepress_get_option('cinnamon_edit_page'),
                                ]);
                                ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="url" name="ip_et_login" id="ip_et_login" value="<?php echo imagepress_get_option('ip_et_login'); ?>" class="regular-text">
                ...
                <table class="form-table">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input type="number" name="ip_cards_per_author" id="ip_cards_per_author" value="<?php echo imagepress_get_option('ip_cards_per_author'); ?>" min="0" max="32">
                            </td>
                        </tr>
                    </tbody>
                </table>
                            ...
                            <td>
                                <p>
                                    <select name="cinnamon_hide_admin" id="cinnamon_hide_admin">
                                        <option value="1"<?php if(imagepress_get_option('cinnamon_hide_admin') == 1) echo ' selected'; ?>>Hide admin bar for non-admin users</option>
                                        <option value="0"<?php if(imagepress_get_option('cinnamon_hide_admin') == 0) echo ' selected'; ?>>Show admin bar for non-admin users</option>
                                    </select>
                                </p>
                                <hr>
                                <p>
                                    <input type="checkbox" class="wppd-ui-toggle" id="cinnamon_fancy_header" name="cinnamon_fancy_header" value="yes" <?php if(imagepress_get_option('cinnamon_fancy_header') == 'yes') echo 'checked'; ?>> <label for="cinnamon_fancy_header">Use a fancy header to display user data (cover image and styled avatar)</label>
                ...
                <table class="form-table">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <p>
                                    <input type="checkbox" class="wppd-ui-toggle" id="approvednotification" name="approvednotification" value="yes" <?php if(imagepress_get_option('approvednotification') == 'yes') echo 'checked'; ?>> <label for="approvednotification">Notify author when image is approved</label>
                                    <br>
                                    <input type="checkbox" class="wppd-ui-toggle" id="declinednotification" name="declinednotification" value="yes" <?php if(imagepress_get_option('declinednotification') == 'yes') echo 'checked'; ?>> <label for="declinednotification">Notify author when image is rejected</label>
                                </p>
                            </td>
                        </tr>
                    </tbody>
                ...
                <table class="form-table">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input type="text" name="ip_caption_label" id="ip_caption_label" value="<?php echo imagepress_get_option('ip_caption_label'); ?>" class="regular-text">
                            </td>
                        </tr>
                        <tr>
                            <th scope="row"><label for="ip_category_label">Image category label<br><small>(dropdown)</small></label></th>
                            <td>
                                <input type="text" name="ip_category_label" id="ip_category_label" value="<?php echo imagepress_get_option('ip_category_label'); ?>" class="regular-text">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input type="text" name="ip_description_label" id="ip_description_label" value="<?php echo imagepress_get_option('ip_description_label'); ?>" class="regular-text">
                            </td>
                        </tr>
                        <tr>
                            <th scope="row"><label for="ip_upload_label">Image upload button label<br><small>(button)</small></label></th>
                            <td>
                                <input type="text" name="ip_upload_label" id="ip_upload_label" value="<?php echo imagepress_get_option('ip_upload_label'); ?>" class="regular-text">
                            </td>
                        </tr>
                        <tr>
                            <th scope="row"><label for="ip_image_label">Image upload selection label<br><small>(link)</small></label></th>
                            <td>
                                <input type="text" name="ip_image_label" id="ip_image_label" value="<?php echo imagepress_get_option('ip_image_label'); ?>" class="regular-text">
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table class="form-table">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input type="text" name="ip_notifications_mark" id="ip_notifications_mark" value="<?php echo imagepress_get_option('ip_notifications_mark'); ?>" class="regular-text">
                            </td>
                        </tr>
                        <tr>
                            <th scope="row"><label for="ip_notifications_all">"View all notifications" label</label></th>
                            <td>
                                <input type="text" name="ip_notifications_all" id="ip_notifications_all" value="<?php echo imagepress_get_option('ip_notifications_all'); ?>" class="regular-text">
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table class="form-table">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input type="text" name="ip_upload_success_title" id="ip_upload_success_title" value="<?php echo imagepress_get_option('ip_upload_success_title'); ?>" class="regular-text">
                            </td>
                        </tr>
                        <tr>
                            <th scope="row"><label for="ip_upload_success">Upload success</label></th>
                            <td>
                                <input type="text" name="ip_upload_success" id="ip_upload_success" value="<?php echo imagepress_get_option('ip_upload_success'); ?>" class="regular-text">
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table class="form-table">
                    <tbody>
                        <tr>
                            ...
                            <td>
                            <p>
                                <input type="text" name="ip_vote_like" id="ip_vote_like" value="<?php echo imagepress_get_option('ip_vote_like'); ?>" placeholder="I like this image" class="regular-text">
                                <label for="ip_vote_like">"Like" label</label>
                                <br><small>Examples: Like, Appreciate, Love, Vote</small>
                                <br>
                                <input type="text" name="ip_vote_unlike" id="ip_vote_unlike" value="<?php echo imagepress_get_option('ip_vote_unlike'); ?>" placeholder="Oops! I don't like this" class="regular-text">
                ...
                <table class="form-table">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input name="ip_max_quality" id="ip_max_quality" type="number" value="<?php echo imagepress_get_option('ip_max_quality')?>" min="0" max="100">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" name="ip_upload_size" id="ip_upload_size" min="0" max="65536" step="1024" value="<?php echo imagepress_get_option('ip_upload_size'); ?>">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="ip_cat_exclude" id="ip_cat_exclude" value="<?php echo imagepress_get_option('ip_cat_exclude'); ?>">
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="ip_upload_secondary" id="ip_upload_secondary">
                                    <option value="1"<?php if(imagepress_get_option('ip_upload_secondary') == 1) echo ' selected'; ?>>Enable secondary upload button</option>
                                    <option value="0"<?php if(imagepress_get_option('ip_upload_secondary') == 0) echo ' selected'; ?>>Disable secondary upload button</option>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="ip_upload_tos" id="ip_upload_tos">
                                    <option value="1"<?php if(imagepress_get_option('ip_upload_tos') == 1) echo ' selected'; ?>>Enable terms and conditions</option>
                                    <option value="0"<?php if(imagepress_get_option('ip_upload_tos') == 0) echo ' selected'; ?>>Disable terms and conditions</option>
                                </select> <label for="ip_upload_tos">Enable/disable terms and conditions of use</label>
                                <br>
                                <input type="text" name="ip_upload_tos_content" id="ip_upload_tos_content" class="regular-text" value="<?php echo imagepress_get_option('ip_upload_tos_content'); ?>" placeholder="I agree with the terms and conditions"> <label for="ip_upload_tos_content">Terms and conditions of use body</label>
                                <br>
                                <input type="text" name="ip_upload_tos_error" id="ip_upload_tos_error" class="regular-text" value="<?php echo imagepress_get_option('ip_upload_tos_error'); ?>" placeholder="Please indicate that you accept the terms and conditions of use"> <label for="ip_upload_tos_error">Terms and conditions of use error</label>
                                <br>
                                <input type="url" name="ip_upload_tos_url" id="ip_upload_tos_url" class="regular-text" value="<?php echo imagepress_get_option('ip_upload_tos_url'); ?>" placeholder="https://"> <label for="ip_upload_tos_url">Terms and conditions of use URL</label>
            ...
            foreach($results as $result) {
                ...
                <div id="notification-<?php echo $result->ID; ?>">
                    ...
                    if ((string) $action === 'loved')
                        $display .= get_avatar($result->userID, 16) . ' <a href="' . imagepress_get_profile_uri($result->userID, false) . '">' . $nickname . '</a> ' . $action . ' <a href="' . get_permalink($result->postID) . '">' . get_the_title($result->postID) . '</a> <time>' . $time . '</time>';

                    else if ((string) $action === 'collected')
                        $display .= get_avatar($result->userID, 16) . ' <a href="' . imagepress_get_profile_uri($result->userID, false) . '">' . $nickname . '</a> ' . $action . ' <a href="' . get_permalink($result->postID) . '">' . get_the_title($result->postID) . '</a> into a <a href="' . get_permalink($ipCollectionsPageId) . '?collection=' .  $result->postKeyID . '">collection</a> <time>' . $time . '</time>';

                    else if ((string) $action === 'added')
                        $display .= get_avatar($result->userID, 16) . ' <a href="' . imagepress_get_profile_uri($result->userID, false) . '">' . $nickname . '</a> ' . $action . ' <a href="' . get_permalink($result->postID) . '">' . get_the_title($result->postID) . '</a> <time>' . $time . '</time>';

                    else if ((string) $action === 'followed')
                        $display .= get_avatar($result->userID, 16) . ' <a href="' . imagepress_get_profile_uri($result->userID, false) . '">' . $nickname . '</a> ' . $result->actionType . ' you <time>' . $time . '</time>';

                    else if ((string) $action === 'commented on') {
                        $who = '<a href="' . imagepress_get_profile_uri($result->userID, false) . '">' . $nickname . '</a>';
                        ...
                        $display .= get_avatar($result->userID, 16) . ' <a href="' . imagepress_get_profile_uri($result->userID, false) . '">' . $nickname . '</a> replied to a comment on <a href="' . get_permalink($comment_post_ID) . '">' . get_the_title($comment_post_ID) . '</a> <time>' . $time . '</time>';
                    }
